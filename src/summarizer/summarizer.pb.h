...
enum SummaryLength_LengthUnit {
  ...
  SummaryLength_LengthUnit_SENTENCE = 3,
  SummaryLength_LengthUnit_NUM_LENGTH_UNITS = 4
};
...
class SummarizerOptions : public ::google::protobuf::Message {
 public:
  ...
  static const int kKlsumOptionsFieldNumber = 11;
  ...
  static const int kTopicsumOptionsFieldNumber = 12;
  ...
  static const int kArticleFieldNumber = 6;

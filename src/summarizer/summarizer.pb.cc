...
void protobuf_AssignDesc_summarizer_2fsummarizer_2eproto() {
  ...
  static const int SummaryOptions_offsets_[1] = {
  ...
  static const int KLSumOptions_offsets_[3] = {
  ...
  SummarizerOptions_descriptor_ = file->message_type(6);
  static const int SummarizerOptions_offsets_[4] = {
...
void protobuf_AddDesc_summarizer_2fsummarizer_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "istribution.proto\")\n\007Article\022\017\n\007content\030"
    "\001 \001(\t\022\r\n\005score\030\002 \003(\002\"9\n\016SummaryOptions\022\'"
    "\n\006length\030\001 \001(\0132\027.topicsum.SummaryLength\""
    "\235\001\n\rSummaryLength\0220\n\004unit\030\001 \002(\0162\".topics"
    "um.SummaryLength.LengthUnit\022\016\n\006length\030\002 "
    "\002(\005\"J\n\nLengthUnit\022\r\n\tCHARACTER\020\000\022\t\n\005TOKE"
    "N\020\001\022\014\n\010SENTENCE\020\003\022\024\n\020NUM_LENGTH_UNITS\020\004\""
    "t\n\024GibbsSamplingOptions\022\027\n\niterations\030\001 "
    "\001(\005:\003500\022\021\n\006burnin\030\002 \001(\005:\0010\022\017\n\003lag\030\003 \001(\005"
    ":\00210\022\037\n\020track_likelihood\030\004 \001(\010:\005false\"\222\002"
    "\n\014KLSumOptions\022_\n\025optimization_strategy\030"
    "\001 \001(\0162+.topicsum.KLSumOptions.Optimizati"
    "onStrategy:\023GREEDY_OPTIMIZATION\022!\n\022redun"
    "dancy_removal\030\002 \001(\010:\005false\022 \n\021sentence_p"
    "osition\030\003 \001(\010:\005false\"\\\n\024OptimizationStra"
    "tegy\022\027\n\023GREEDY_OPTIMIZATION\020\000\022\024\n\020SENTENC"
    "E_RANKING\020\001\022\025\n\021NUM_OPTIMIZATIONS\020\002\"\201\001\n\017T"
    "opicSumOptions\022>\n\026gibbs_sampling_options"
    "\030\002 \001(\0132\036.topicsum.GibbsSamplingOptions\022\027"
    "\n\006lambda\030\003 \001(\t:\0070.1,1,1\022\025\n\005gamma\030\004 \001(\t:\006"
    "1,5,10\"\215\002\n\021SummarizerOptions\022=\n\014summary_"
    "type\030\001 \002(\0162\'.topicsum.SummarizerOptions."
    "SummaryType\022-\n\rklsum_options\030\013 \001(\0132\026.top"
    "icsum.KLSumOptions\0223\n\020topicsum_options\030\014"
    " \001(\0132\031.topicsum.TopicSumOptions\022\"\n\007artic"
    "le\030\006 \003(\0132\021.topicsum.Article\"1\n\013SummaryTy"
    "pe\022\013\n\007GENERIC\020\001\022\t\n\005QUERY\020\002\022\n\n\006UPDATE\020\004", 1158);
...
const Article& Article::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_summarizer_2fsummarizer_2eproto();  return *default_instance_;
}
...
const ::std::string TopicSumOptions::_default_lambda_("0.1,1,1");
const ::std::string TopicSumOptions::_default_gamma_("1,5,10");
#ifndef _MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(50)) goto parse_article;
        break;
      }
      
      // repeated .topicsum.Article article = 6;
      case 6: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_LENGTH_DELIMITED) {
         parse_article:
        ...
        if (input->ExpectTag(50)) goto parse_article;
        if (input->ExpectTag(90)) goto parse_klsum_options;
        break;
      }
      
      // optional .topicsum.KLSumOptions klsum_options = 11;
      case 11: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_LENGTH_DELIMITED) {
         parse_klsum_options:
        ...
        if (input->ExpectTag(98)) goto parse_topicsum_options;
        break;
      }
      
      // optional .topicsum.TopicSumOptions topicsum_options = 12;
      case 12: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_LENGTH_DELIMITED) {
...
void SummarizerOptions::SerializeWithCachedSizes(
  ...
  for (int i = 0; i < this->article_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      6, this->article(i), output);
  }
  
  // optional .topicsum.KLSumOptions klsum_options = 11;
  if (has_klsum_options()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      11, this->klsum_options(), output);
  }
  
  // optional .topicsum.TopicSumOptions topicsum_options = 12;
  if (has_topicsum_options()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      12, this->topicsum_options(), output);
  }
...
::google::protobuf::uint8* SummarizerOptions::SerializeWithCachedSizesToArray(
  ...
  if (has_topicsum_options()) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteMessageNoVirtualToArray(
        12, this->topicsum_options(), target);
  }
